...
<div class="mb-3">
    ...
    <h2 class="d-inline"><i class="bi bi-plus-circle me-2"></i>Dodaj firmę</h2>
</div>
...
<form method="POST" action="{{ route('companies.store') }}">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nip" id="nip" class="form-control @error('nip') is-invalid @enderror"
               value="{{ old('nip') }}" maxlength="10" pattern="[0-9]{10}">
    ...
    <a href="{{ route('companies.index') }}" class="btn btn-outline-secondary">Anuluj</a>
</form>
@endsection
